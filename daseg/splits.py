"""
Standard SWDA train/dev/test splits definition.
Source: https://github.com/Franck-Dernoncourt/naacl2016
"""
...
assert not (set(train_set_idx) & set(valid_set_idx))
assert not (set(train_set_idx) & set(test_set_idx))
assert not (set(valid_set_idx) & set(test_set_idx))
