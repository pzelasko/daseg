...
frame_len=0.1
suffix=_frame_len${frame_len}_MultiModal_bs${batch_size}_gacc${gacc}_concat_aug_${concat_aug}_maxlenspeech_${max_sequence_length}_Epochs_${no_epochs}_2CrossAttLayers_temp
...
do
    python daseg/bin/run_journal_jobs_temp.py --data-dir $data_dir \
